...
wire m_service = 1'b0;
wire [7:0] pcb = 8'b0;
wire [7:0] DIP1 = 8'b10000000;
wire [7:0] DIP2 = 8'b11111111;
wire [7:0] DIP3 = 8'b00000000;
wire core_pix_clk; 
...
dpram #(12,8) U105_U104_RAM_2016 //VIDEO RAM
(
	.clock_a(clkm_48MHZ),
...
dpram #(12,8) U107_U106_RAM_2016 //VIDEO RAM
(
	.clock_a(clkm_48MHZ),
	.address_a(VRAM_ADDR), //!SELVRAM_B1
	.data_a(),
...
dpram #(12,8) U109_U108_RAM_2016 //VIDEO RAM
(
	.clock_a(clkm_48MHZ),
	.address_a(VRAM_ADDR), //!SELVRAM_B1
	.data_a(),
...
gen_ram #(8,11) U14_RAM_2016 //SJ
(
	.clk(clkm_32MHZ),
	.we(!Z80A_WR & SRAMREQ),	
	.addr(Z80A_addrbus[10:0]),
	.d(Z80A_databus_out),
	.q(Z80A_RAM_out)
);
...
assign EB16_out = EB16_out_all[3:0];
...
dpram #(6,16) U67_RAM //SJ - using 16-bit memory for 9-bit
(
	.clock_a(clkm_48MHZ),
	.address_a(MA),
	.data_a(),
